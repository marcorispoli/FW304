...
#define MET_CAN_APP_DEVICE_ID     0x14 //!< Application DEVICE CAN Id address
#define MET_CAN_STATUS_REGISTERS    0 //!< Defines the total number of implemented STATUS registers 
#define MET_CAN_DATA_REGISTERS      0 //!< Defines the total number of implemented Application DATA registers 
#define MET_CAN_PARAM_REGISTERS     0 //!< Defines the total number of implemented PARAMETER registers 
